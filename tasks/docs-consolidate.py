...
# SPDX-FileCopyrightText: 2022 Data Banana <https://data-banana.github.io/>
...
PATH_DBT_PROJECT = Path(__file__).parents[1]
...
# In the static website there are 2 more projects inside the documentation: dbt
# and dbt_postgres. This is technical information that we don't want to provide
# to our final users, so we drop it
...
for element_type in [
    ...
    # We transform to list to not change dict size during iteration, we use
    # default value {} to handle KeyError
